...
# СОЗДАЕМ ОТДЕЛЬНЫЙ СЛОВАРЬ ДЛЯ ВРЕМЕННЫХ ДАННЫХ
temp_storage = {}
...
async def handle_broadcast(message: types.Message):
    try:
        ...
        print(f"❌ Ошибка в handle_broadcast: {e}")
...
async def broadcast_confirmation(call: types.CallbackQuery):
    try:
        ...
        print(f"❌ Ошибка в broadcast_confirmation: {e}")
